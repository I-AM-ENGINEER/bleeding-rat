/*
    Данный пример демонстрирует чтение ускорений с гироскопа и акселерометра. 
    Выходные данные: 
        - линейные ускорения (массив a) в метрах/секунда 
        - угловые ускорения (массив b) в град/с^2
        - температура датчика t в градусах цельсия
*/
