...
int main(void)
{
  ...
  loopTaskHandle = osThreadNew(StartLoopTask, NULL, &loopTask_attributes);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, MP6500_CS_Pin|MOT_PWR_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(WS2812B_GPIO_Port, WS2812B_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : MP6500_CS_Pin MOT_PWR_EN_Pin */
  GPIO_InitStruct.Pin = MP6500_CS_Pin|MOT_PWR_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : HALL1_EXTI_Pin HALL2_EXTI_Pin HALL3_EXTI_Pin */
  GPIO_InitStruct.Pin = HALL1_EXTI_Pin|HALL2_EXTI_Pin|HALL3_EXTI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : TP4056_CHRG_Pin TP4056_STDBY_Pin */
  GPIO_InitStruct.Pin = TP4056_CHRG_Pin|TP4056_STDBY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pin : HALL4_EXTI_Pin */
  GPIO_InitStruct.Pin = HALL4_EXTI_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(HALL4_EXTI_GPIO_Port, &GPIO_InitStruct);
